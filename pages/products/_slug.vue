<template>
    <main>
        <template v-if="banner != null">
            <section class="slice pt-sm pb-4 d-flex align-items-end  bg-cover bg-size--cover" :style="'background-image: url('+banner.imagelink+'banners/'+banner.banner+');'">
        ...
        <template v-else>
            <section class="slice pt-sm pb-4 d-flex align-items-end  bg-cover bg-size--cover" style="background-image: url('/img/backgrounds/general.png');">
                <span class="mask bg-danger opacity-5"></span>
                <div class="container pt-lg">
                    <div class="row">
                        <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <div class="row">
                            <div class="col-lg-6">
                                <span v-for="(variations, type) in product.variations" :key="type">
                                    <template v-if="type == showingproduct">
                                        <no-ssr>
                                            <ProductZoomer
                                                :base-images="images"
                            ...
                            <!-- <div class="col-lg-6" v-for="(variations, type) in product.variations" :key="type">
                                <template v-if="type == showingproduct">
                                    <no-ssr>
                                        <ProductZoomer
                                            :base-images="images"
                            ...
                            <div class="col-lg-6">
                                <form class="pl-lg-4">
                                    ...
                                    <!-- Product description -->
                                    <div class="pt-2 mt-3 delimiter-top">
                                        <small class="text-dark font-weight-bold d-block mb-2" v-if="product.description">Description:</small>
                                        <p class="text-sm lh-150" v-if="product.description">{{ product.description }}</p>
                                    </div>

                                    <!-- Product Price -->
                                    <div class="pt-2 mt-3 delimiter-top">
                                        <small class="text-dark font-weight-bold d-block mb-2">Unit price:</small>
                                        <template v-if="unitcost != null">Ksh. {{unitcost}}</template>
                                        <template v-else><p class="text-sm lh-150">Ksh. {{ product.price }}</p></template>
                                    </div>
                                    ...
                                    <div class="pt-2 mt-3 delimiter-top">
                                        ...
                                        <div class="d-flex">
                                            <div class="custom-color" v-for="(vr, index) in product.variations" :key="index" >
                                                <el-tooltip :content="vr[0].type+' @ '+vr[0].price+'/='" placement="top">
                                                    <input :id="'color-'+vr[0].id" name="size" type="radio">
                                                    <label :for="'color-'+vr[0].id" class="rounded-circle border-danger" :style="'background-color:'+vr[0].colorcode" @click="showshoe(vr, vr[0].type, vr[0].price)"></label>
                                                </el-tooltip>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section pt-2 mt-3 delimiter-top">
                                        <!-- <form @submit.prevent="add"> -->
                                        <small class="d-block font-weight-bold text-dark mb-2">Sizes:</small>
                                        <ProductVariation
                                        ...
                                        <div v-if="form.variation">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-4">
                                                    <button @click.prevent="postWishlist" type="button" class="btn btn-info btn-sm">Add to wishlist</button>
                                                </div>
                                            </div>
                                        </div>

                                        <div v-if="addedtocart" class="animated bounceInDown card card-stats bg-gradient-success shadow-success border-0 mt-4">
                                            <div class="card-body p-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="pl-4">
                                                        <h5 class="mb-1 text-white">{{successmessage}}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div v-if='errors' class="card card-stats bg-gradient-warning shadow-warning border-0 mb-4">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div>
                                                    <span class="icon icon-sm text-white">
                                                ...
                                                <div class="pl-4">
                                                    <h5 class="mb-1 text-white">Quantity error</h5>
                                                    <p v-text="errors['0']"></p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <section class="slice slice-md delimiter-top">
            ...
            <div class="container position-relative zindex-100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 mb-5" v-for="product in ralated" :key="product.slug">
        ...
        <!-- <section class="slice overflow-hidden pb-4">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card bg-gradient-danger border-0 shadow mb-4">
                            <div class="card-body py-3">
                                <div class="row row-grid align-items-center">
                                    <div class="col-lg-8">
                                        <div class="media align-items-center">
                                            <span class="avatar avatar-lg rounded-circle mr-3">
                                                <img v-if="user.avatar != null" alt="Image placeholder" :src="url+'users/'+user.avatar">
                                                <img v-else alt="Image placeholder" src="/img/prv/team-7-800x800.jpg">
                                                <img alt="Image placeholder" src="/img/prv/team-7-800x800.jpg">
                                            </span>
                                    ...
                                    <div class="col-auto flex-fill mt-4 mt-sm-0 text-sm-right d-none d-lg-block">
                                        <button @click="showaction" class="btn btn-sm btn-white btn-circle btn-icon shadow">
                                            <span class="btn-inner--icon"><i class="far fa-comments"></i></span>
                                            <span v-if="!showcomments" class="btn-inner--text">Show reviews</span>
                                            <span v-else class="btn-inner--text">Hide reviews</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 mx-auto animated bounceInDown faster" v-if="showcomments">
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="media media-comment" v-for="cm in approvecomments" :key="cm.id">
                                        <a href="#" class="avatar avatar-sm rounded-circle mr-3">
                                            <img v-if="user.avatar != null" alt="Image placeholder" :src="url+'users/'+user.avatar">
                                            <img v-else alt="Image placeholder" src="/img/prv/team-1-800x800.jpg">
                                            <img alt="Image placeholder" src="/img/prv/team-1-800x800.jpg">
                                        </a>
                                        <div class="media-body">
                                            <div class="media-text-bubble left-top">
                                                <h6 class="mt-0">{{cm.username}}</h6>
                                                <p class="text-sm lh-160">{{cm.comment}}</p>
                                                <div class="icon-actions">
                                                    <small class="text-info font-weight-bold">{{cm.created_at}}</small>
                                    ...
                                    <div class="media media-comment">
                                        ...
                                        <div class="media-body">
                                            <form @submit.prevent="postComment">
                                                <div class="row">
                                                    <div class="col-10">
                                                        <textarea v-model="comment" style="resize:none;" class="form-control" placeholder="Write your comment" rows="1"></textarea>
                                                        <p class="small text-danger" v-if="errors.comment">
                                                            {{ errors.comment[0] }}
                                                        </p>
                                                    </div>
                                                    <div class="col-2">
                                                        <button class="btn btn-sm btn-white btn-circle btn-icon shadow">Post</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
    ...
    export default {
        ...
        computed: {
            approvecomments: function(){
                var filtered = [];
                filtered = this.product.comments.filter((rpt) => {
                    return rpt.status == 1
                })
                return filtered;
            },
        ...
        methods: {
            ...
            imagegtouping(array, name){
                var newimg = [];
                for (let i = 0; i < array.length; i++) {
                    if (array[i].colorname == name) {
                        array[i].id = [i][0]
                        newimg.push(array[i]);
                    }
                }
            ...
            //     try {
            //         let response = await this.$axios.$post('cart', {"products":[{"id":this.form.variation.id,"quantity":this.form.quantity}]})
            //     } catch (e) {
            ...
            add() {
                if (!this.$auth.loggedIn) {
                    ...
                    // this.$localForage.setItem('redirect', $nuxt.$route.params)
                    this.setredirecturl($nuxt.$route.params)
                    this.$router.push({
                        name: "auth-signin"
                    });
                    return;
            ...
            showshoe(shoe, type, unitprice){
                this.unitcost = unitprice
                this.showingproduct = type
                this.images = null
                this.images = {
                    'thumbs': this.imagegtouping(this.product.thumbs, this.showingproduct),
                    'normal_size': this.imagegtouping(this.product.normal_size, this.showingproduct),
                    'large_size': this.imagegtouping(this.product.large_size, this.showingproduct)
                }
            },
            async postWishlist(){
                await this.$axios.$post('wishlist', {'product': this.product.id})
                this.successmessage = 'Added to wishlist !';
                this.show()
            },
            async postComment(){
                try {
                    let response = await this.$axios.$post('comments', {'comment': this.comment, 'product': this.product.id})
                    if (response.data) {
                        this.comment = null
                    }
                } catch (e) {
        ...
        async asyncData({ params, app }) {
            ...
            // let res = await app.$axios.$get(`auth/me`);
            function idrearrange(array) {
                for (let i = 0; i < array.length; i++) {
                    array[i].id = [i][0]+1
                }
                return array;
            ...
            return {
                showingproduct: Object.keys(response.data.variations)[0],
                product: response.data,
                // user: res.data,
                ralated: response.ralated,
                banner: response.banner,
                images: {
                    'thumbs': idrearrange(response.data.thumbs),
                    'normal_size': idrearrange(response.data.normal_size),
                    'large_size': idrearrange(response.data.large_size)
                }
