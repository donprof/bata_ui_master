<template>
    <section class="section-rotate pb-0 mt--100">
      <div class="section-inner" :class="bgclass"></div>
      <!--Illustation -->
      <div class="pt-5 position-absolute middle right-0 col-lg-7 col-xl-7 d-none d-lg-block">
          <img alt="" :src="'/img/svg/'+bannerimage" class="img-fluid">
      </div>
      ...
      <!-- Hero container -->
      <div class="container pt-lg-lg pt-sm-sm pb-xl-md position-relative zindex-100">
          <div class="row">
              <div class="col-lg-6 text-center text-lg-left mt-5 pt-5">
                  <div>
                      <h2 class="text-white my-5">
                          <span class="display-4 font-weight-light">Hi, {{ user }}</span>
                          <span class="d-block">Your cart total is: <strong class="font-weight-light">Ksh {{totalcost}}</strong></span>
                      </h2>
                      <p class="lead text-white">You are free to add products to it and include shiping mehthods to it. Currently yuo have <strong class="font-weight-light">{{cartCount}}</strong> Items to it. </p>
                  </div>
              </div>
          </div>
      </div>
